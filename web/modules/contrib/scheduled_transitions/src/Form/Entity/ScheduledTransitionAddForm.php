...
class ScheduledTransitionAddForm extends ContentEntityForm {
  ...
  protected function init(FormStateInterface $form_state) {
    ...
    // If the form's operation doesn't match a form display, the "default" form
    // display is set as the form's display. This may cause modules altering
    // entity forms based on the form display (such as the field_group module)
    // to alter forms they don't intend to.
